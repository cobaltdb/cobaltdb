...
func TestHandleQueryWithNilDB(t *testing.T) {
	...
	response := client.handleQuery(t.Context(), query)
...
func TestNewServerWithNilDB(t *testing.T) {
	...
	if srv.prodServer != nil {
		t.Error("Server prodServer should be nil")
	}
}
...
func TestHandleQueryWithMultipleParams(t *testing.T) {
	...
	// Setup
	db.Exec(t.Context(), "CREATE TABLE test (id INTEGER, name TEXT, age INTEGER)")
