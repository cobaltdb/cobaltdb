...
| **Security** | ✅ Production-Oriented | scans clean | RLS, audit, TLS, encryption; audit logs are encrypted, hash-chained, and offline-verifiable; external signing/key rotation remain roadmap |
