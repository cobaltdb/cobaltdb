...
run_bench ./pkg/engine/ 'Benchmark(ExecInsert$|ExecSelect$|ExecSelectIndexed$|TransactionCommit$|PreparedStatement$|ConcurrentWriters$|WriteLatencyUnderReaders|WriteLatencyUnderOrderedReaders)'
